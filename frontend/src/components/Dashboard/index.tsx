...
export default function Dashboard() {
  ...
  const [lembretes, setLembretes] = useState([
    {
      id: 1,
      text: "Enviar lembrete para Grupo A - Engenharia de Software",
      color: "text-yellow-500",
    },
    {
      id: 2,
      text: "Revisar avaliações de Banco de Dados",
      color: "text-green-500",
    },
    {
      id: 3,
      text: "Finalizar período de avaliação para IA em 2 dias",
      color: "text-red-500",
    },
  ]);
                  ...
                  <li key={index} className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500">
                        Grupo A - Engenharia de Software
                      </p>
                    </div>
                  </li>
                ))}
        ...
        <Dialog open={showDialog} onOpenChange={setShowDialog}>
          <DialogContent className="sm:max-w-[425px]">
            <DialogHeader>
              ...
              <DialogDescription>
                Insira o texto do novo lembrete abaixo.
              </DialogDescription>
            </DialogHeader>
            <div className="mt-4">
              <Input
